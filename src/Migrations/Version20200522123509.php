 ...
 */
final class Version20200522123509 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE mustache (id INT AUTO_INCREMENT NOT NULL, environment_id INT NOT NULL, name VARCHAR(255) NOT NULL, function LONGTEXT DEFAULT NULL, INDEX IDX_488F3D88903E3A94 (environment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
